...
class TestPayrollTierValidation(common.SavepointCase):
    @classmethod
    def setUpClass(cls):
        super(TestPayrollTierValidation, cls).setUpClass()
    ...
    def tearDownClass(cls):
        ...
        super(TestPayrollTierValidation, cls).tearDownClass()
